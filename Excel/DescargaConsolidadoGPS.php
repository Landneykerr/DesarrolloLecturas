<?php
	...
	$anno       = $_GET['Anno'];
	$ciclo  	= $_GET['Ciclo'];
	$nombreArchivo = "ConsolidadoGPS_".$ciclo."_".$mes."_".$anno.".xlsx";
	...
	$fila = 1;
	$campos = array("CUENTA","LONGITUD","LATITUD","X","Y","FECHA TOMA");	
	...
	$_query = $_myDataBase->PostgresFunctionCamposTable("cuenta,longitud,latitud,x,y,fecha_toma","toma.consolidado_puntosgps(".$mes.",".$anno.",".$ciclo.")"); 
	...
	$prueba->getActiveSheet()->setTitle("ConsolidadoGPS"); 
