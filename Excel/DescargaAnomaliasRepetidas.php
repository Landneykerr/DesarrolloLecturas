<?php
	...
	$nombreArchivo = "AnomaliasIguales".$ciclo."_".$mes."_".$anno.".xlsx";
	...
	$fila = 1;
	$campos = array("CUENTA","MEDIDA","NOMBRE","MEDIDOR","PERIODO1","ANOMALIA1","CRITICA1","FECHA TOMA1","MENSAJE1","PERIODO2","ANOMALIA2","CRITICA2","FECHA TOMA2","MENSAJE2","PERIODO3","ANOMALIA3","CRITICA3","FECHA TOMA3","MENSAJE3");	
	...
	$_query = $_myDataBase->PostgresFunctionCamposTable("cuenta,medida,nombre,medidor,periodo1,anomalia1,critica1,fecha_toma1,mensaje1,periodo2,anomalia2,critica2,fecha_toma2,mensaje2,periodo3,anomalia3,critica3,fecha_toma3,mensaje3",
														"reportes.reporte_anomalias_iguales(".$ciclo.",".$mes.",".$anno.")"); 
